...
\begin{align}
	...
	\mathbf{Q} &= \begin{bmatrix} 2.7878\cdot 10^{-8} & 0 & 0\\ 0 & 9.4124\cdot 10^{-8} & 0 \\ 0&0& 10^{-4}\end{bmatrix} \begin{bmatrix} \text{m}^2 \\ \text{rad}^2 \\ \left(\frac{\text{m}}{\text{s}}\right)^2\end{bmatrix} \\
	\mathbf{\hat{P}_{0|0}} &= 0
\end{align}
