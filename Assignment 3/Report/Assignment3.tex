...
%		\centering
%		\includegraphics[width=\textwidth]{impulse_response1.eps}
%	\end{subfigure}
%	\hfill
%	\begin{subfigure}[b]{0.48\textwidth}  
%		\centering 
%		\includegraphics[width=\textwidth]{impulse_response3.eps}
%	\end{subfigure}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=\linewidth]{impulse_response1.eps}
